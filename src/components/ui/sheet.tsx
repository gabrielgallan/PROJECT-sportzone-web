...
function SheetOverlay({
	...
	return (
		<SheetPrimitive.Overlay
			...
			className={cn(
				'fixed inset-0 z-50 bg-black/10 duration-300 supports-backdrop-filter:backdrop-blur-xs',
	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				data-side={side}
				className={cn(
					'fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition ease-in-out duration-300',
